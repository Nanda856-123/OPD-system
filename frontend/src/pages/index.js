...
export { default as Departments } from './Admin/Departments';
...
export { default as Consultation } from './Doctor/Consultation';
export { default as PatientHistory } from './Doctor/PatientHistory';